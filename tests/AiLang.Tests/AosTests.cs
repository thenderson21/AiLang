...
public class AosTests
{
    ...
    [Test]
    public void RunEmbeddedBytecode_CVmMode_ReturnsDev008Gate()
    {
    ...
    public void RunEmbeddedBytecode_CVmMode_ExecuteEnabledMissingLibrary_ReturnsDev008BridgeUnavailable()
    {
        ...
        try
        {
            ...
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_LIB", fakeLibPath);
    ...
    [Test]
    public void RunEmbeddedBytecode_CVmMode_ExecuteEnabledMissingMain_ReturnsDev008CompatibilityError()
    {
        const string bytecodeText = "Bytecode#bc1(magic=\"AIBC\" format=\"AiBC1\" version=1 flags=0)";
        var previousExecute = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE");
        var previousLib = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_LIB");
    ...
    [Test]
    public void RunEmbeddedBytecode_CVmMode_ExecuteEnabledRetOpcode_PassesCompatibilityAndFailsAtLibraryLoad()
    {
        const string bytecodeText = "Bytecode#bc1(magic=\"AIBC\" format=\"AiBC1\" version=1 flags=0) { Func#f1(name=main params=\"\" locals=\"\") { Inst#i1(op=RET) } }";
        var previousExecute = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE");
        var previousLib = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_LIB");
        var lines = new List<string>();
    ...
    [Test]
    public void RunEmbeddedBytecode_CVmMode_ExecuteEnabledMainWithParams_ReturnsCompatibilityError()
    {
        const string bytecodeText = "Bytecode#bc1(magic=\"AIBC\" format=\"AiBC1\" version=1 flags=0) { Func#f1(name=main params=\"argv\" locals=\"\") { Inst#i1(op=HALT) } }";
        var previousExecute = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE");
        var previousLib = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_LIB");
        var lines = new List<string>();
        ...
        {
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE", "1");
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_LIB", "does-not-matter-for-main-params");
    ...
    [Test]
    public void RunEmbeddedBytecode_CVmMode_ExecuteEnabledCallOutOfRange_ReturnsCompatibilityError()
    {
        const string bytecodeText = "Bytecode#bc1(magic=\"AIBC\" format=\"AiBC1\" version=1 flags=0) { Func#f1(name=main params=\"\" locals=\"\") { Inst#i1(op=CALL a=99 b=0) Inst#i2(op=RET) } }";
        var previousExecute = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE");
        var previousLib = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_LIB");
        var lines = new List<string>();
        ...
        {
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE", "1");
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_LIB", "does-not-matter-for-call-oob");
    ...
    [Test]
    public void RunEmbeddedBytecode_CVmMode_ExecuteEnabledAsyncCallOutOfRange_ReturnsCompatibilityError()
    {
        const string bytecodeText = "Bytecode#bc1(magic=\"AIBC\" format=\"AiBC1\" version=1 flags=0) { Func#f1(name=main params=\"\" locals=\"\") { Inst#i1(op=ASYNC_CALL a=99 b=0) Inst#i2(op=RET) } }";
        var previousExecute = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE");
        var previousLib = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_LIB");
        var lines = new List<string>();
        ...
        {
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE", "1");
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_LIB", "does-not-matter-for-async-call-oob");
    ...
    [Test]
    public void RunEmbeddedBytecode_CVmMode_ExecuteEnabledAsyncCallNegativeTarget_ReturnsCompatibilityError()
    {
        const string bytecodeText = "Bytecode#bc1(magic=\"AIBC\" format=\"AiBC1\" version=1 flags=0) { Func#f1(name=main params=\"\" locals=\"\") { Inst#i1(op=ASYNC_CALL a=-1 b=0) Inst#i2(op=RET) } }";
        var previousExecute = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE");
        var previousLib = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_LIB");
        var lines = new List<string>();
        ...
        {
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE", "1");
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_LIB", "does-not-matter-for-async-call-negative");
            ...
            Assert.That(lines[0], Does.Contain("code=DEV008"));
            Assert.That(lines[0], Does.Contain("VM001:"));
            Assert.That(lines[0], Does.Contain("Call target out of range: -1"));
            Assert.That(lines[0], Does.Contain("nodeId=main"));
        }
        finally
        {
    ...
    [Test]
    public void RunEmbeddedBytecode_CVmMode_ExecuteEnabledJumpNegativeTarget_ReturnsCompatibilityError()
    {
        const string bytecodeText = "Bytecode#bc1(magic=\"AIBC\" format=\"AiBC1\" version=1 flags=0) { Func#f1(name=main params=\"\" locals=\"\") { Inst#i1(op=JUMP a=-1 b=0) Inst#i2(op=RET) } }";
        var previousExecute = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE");
        var previousLib = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_LIB");
        var lines = new List<string>();
        ...
        {
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE", "1");
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_LIB", "does-not-matter-for-jump-negative");
            ...
            Assert.That(lines[0], Does.Contain("code=DEV008"));
            Assert.That(lines[0], Does.Contain("VM001:"));
            Assert.That(lines[0], Does.Contain("Jump target out of range: -1"));
            Assert.That(lines[0], Does.Contain("nodeId=main"));
        }
        finally
        {
    ...
    [Test]
    public void RunEmbeddedBytecode_CVmMode_ExecuteEnabledJumpIfFalseNegativeTarget_ReturnsCompatibilityError()
    {
        const string bytecodeText = "Bytecode#bc1(magic=\"AIBC\" format=\"AiBC1\" version=1 flags=0) { Func#f1(name=main params=\"\" locals=\"\") { Inst#i1(op=PUSH_BOOL a=0 b=0) Inst#i2(op=JUMP_IF_FALSE a=-1 b=0) Inst#i3(op=RET) } }";
        var previousExecute = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE");
        var previousLib = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_LIB");
        var lines = new List<string>();
        ...
        {
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE", "1");
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_LIB", "does-not-matter-for-jump-if-false-negative");
    ...
    [Test]
    public void RunEmbeddedBytecode_CVmMode_ExecuteEnabledParFork_PassesCompatibilityAndFailsAtLibraryLoad()
    {
        const string bytecodeText = "Bytecode#bc1(magic=\"AIBC\" format=\"AiBC1\" version=1 flags=0) { Func#f1(name=main params=\"\" locals=\"\") { Inst#i1(op=PAR_FORK a=0 b=0) } }";
        var previousExecute = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE");
        var previousLib = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_LIB");
        var lines = new List<string>();
        ...
        try
        {
            ...
            Assert.That(lines[0], Does.Contain("code=DEV008"));
            Assert.That(lines[0], Does.Contain("Failed to load AIVM C bridge library path"));
            Assert.That(lines[0], Does.Not.Contain("Opcode 'PAR_FORK' is not yet supported"));
        }
        finally
        {
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE", previousExecute);
    ...
    [Test]
    public void RunEmbeddedBytecode_CVmMode_ExecuteEnabledParCancel_PassesCompatibilityAndFailsAtLibraryLoad()
    {
        const string bytecodeText = "Bytecode#bc1(magic=\"AIBC\" format=\"AiBC1\" version=1 flags=0) { Func#f1(name=main params=\"\" locals=\"\") { Inst#i1(op=PAR_CANCEL a=0 b=0) } }";
        var previousExecute = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE");
        var previousLib = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_LIB");
        var lines = new List<string>();
        ...
        try
        {
            ...
            Assert.That(lines[0], Does.Contain("code=DEV008"));
            Assert.That(lines[0], Does.Contain("Failed to load AIVM C bridge library path"));
            Assert.That(lines[0], Does.Not.Contain("Opcode 'PAR_CANCEL' is not yet supported"));
        }
        finally
        {
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE", previousExecute);
    ...
    [Test]
    public void RunEmbeddedBytecode_CVmMode_ExecuteEnabledCallSysMissingTarget_ReturnsCompatibilityError()
    {
        const string bytecodeText = "Bytecode#bc1(magic=\"AIBC\" format=\"AiBC1\" version=1 flags=0) { Func#f1(name=main params=\"\" locals=\"\") { Inst#i1(op=CALL_SYS a=0 b=1) } }";
        var previousExecute = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE");
        var previousLib = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_LIB");
        var lines = new List<string>();
        ...
        {
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE", "1");
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_LIB", "does-not-matter-for-call-sys-target");
    ...
    [Test]
    public void RunEmbeddedBytecode_CVmMode_ExecuteEnabledAsyncCallSysInvalidSlot_ReturnsCompatibilityError()
    {
        ...
        {
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE", "1");
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_LIB", "does-not-matter-for-async-call-sys-slot");
    ...
    [Test]
    public void RunEmbeddedBytecode_CVmMode_ExecuteEnabledInvalidAbiEnv_ReturnsCompatibilityError()
    {
        const string bytecodeText = "Bytecode#bc1(magic=\"AIBC\" format=\"AiBC1\" version=1 flags=0) { Func#f1(name=main params=\"\" locals=\"\") { Inst#i1(op=HALT) } }";
        var previousExecute = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE");
        var previousLib = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_LIB");
        ...
        {
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE", "1");
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_LIB", "does-not-matter-for-invalid-abi");
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_ABI", "bad-abi");
    ...
    [Test]
    public void RunEmbeddedBytecode_CVmMode_ExecuteEnabledAbiWithWhitespace_ReturnsCompatibilityError()
    {
        const string bytecodeText = "Bytecode#bc1(magic=\"AIBC\" format=\"AiBC1\" version=1 flags=0) { Func#f1(name=main params=\"\" locals=\"\") { Inst#i1(op=HALT) } }";
        var previousExecute = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE");
        var previousLib = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_LIB");
        ...
        {
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE", "1");
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_LIB", "does-not-matter-for-invalid-abi-whitespace");
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_ABI", " 1 ");
    ...
    public void RunEmbeddedBytecode_CVmMode_ExecuteEnabledNonZeroBOperand_ReturnsCompatibilityError()
    {
        ...
        {
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE", "1");
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_LIB", "does-not-matter-for-b-operand");
            ...
            Assert.That(lines.Count, Is.EqualTo(1));
            Assert.That(lines[0], Does.Contain("code=DEV008"));
            Assert.That(lines[0], Does.Contain("unsupported secondary operand b=1"));
        }
        finally
        {
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE", previousExecute);
    ...
    [Test]
    public void RunEmbeddedBytecode_CVmMode_ExecuteEnabledParBeginNonZeroBOperand_ReturnsCompatibilityError()
    {
        const string bytecodeText = "Bytecode#bc1(magic=\"AIBC\" format=\"AiBC1\" version=1 flags=0) { Func#f1(name=main params=\"\" locals=\"\") { Inst#i1(op=PAR_BEGIN b=1) } }";
        var previousExecute = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE");
        var previousLib = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_LIB");
        var lines = new List<string>();
        ...
        {
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE", "1");
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_LIB", "does-not-matter-for-par-b-operand");
            ...
            Assert.That(lines.Count, Is.EqualTo(1));
            Assert.That(lines[0], Does.Contain("code=DEV008"));
            Assert.That(lines[0], Does.Contain("Opcode 'PAR_BEGIN' uses unsupported secondary operand b=1"));
        }
        finally
        {
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE", previousExecute);
    ...
    [Test]
    public void RunEmbeddedBytecode_CVmMode_ExecuteEnabledAwaitNonZeroBOperand_ReturnsCompatibilityError()
    {
        const string bytecodeText = "Bytecode#bc1(magic=\"AIBC\" format=\"AiBC1\" version=1 flags=0) { Func#f1(name=main params=\"\" locals=\"\") { Inst#i1(op=AWAIT b=1) } }";
        var previousExecute = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE");
        var previousLib = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_LIB");
        var lines = new List<string>();
        ...
        {
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE", "1");
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_LIB", "does-not-matter-for-await-b-operand");
            ...
            Assert.That(lines.Count, Is.EqualTo(1));
            Assert.That(lines[0], Does.Contain("code=DEV008"));
            Assert.That(lines[0], Does.Contain("Opcode 'AWAIT' uses unsupported secondary operand b=1"));
        }
        finally
        {
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE", previousExecute);
    ...
    [Test]
    public void RunEmbeddedBytecode_CVmMode_ExecuteEnabledUnexpectedStringOperand_ReturnsCompatibilityError()
    {
        const string bytecodeText = "Bytecode#bc1(magic=\"AIBC\" format=\"AiBC1\" version=1 flags=0) { Func#f1(name=main params=\"\" locals=\"\") { Inst#i1(op=HALT s=\"extra\") } }";
        var previousExecute = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE");
        var previousLib = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_LIB");
        var lines = new List<string>();
        ...
        {
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE", "1");
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_LIB", "does-not-matter-for-s-operand");
            ...
            Assert.That(lines.Count, Is.EqualTo(1));
            Assert.That(lines[0], Does.Contain("code=DEV008"));
            Assert.That(lines[0], Does.Contain("unsupported string operand s"));
        }
        finally
        {
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE", previousExecute);
    ...
    [Test]
    public void RunEmbeddedBytecode_CVmMode_ExecuteEnabledParBeginUnexpectedStringOperand_ReturnsCompatibilityError()
    {
        const string bytecodeText = "Bytecode#bc1(magic=\"AIBC\" format=\"AiBC1\" version=1 flags=0) { Func#f1(name=main params=\"\" locals=\"\") { Inst#i1(op=PAR_BEGIN s=\"meta\") } }";
        var previousExecute = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE");
        var previousLib = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_LIB");
        var lines = new List<string>();
        ...
        {
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE", "1");
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_LIB", "does-not-matter-for-par-s-operand");
            ...
            Assert.That(lines.Count, Is.EqualTo(1));
            Assert.That(lines[0], Does.Contain("code=DEV008"));
            Assert.That(lines[0], Does.Contain("Opcode 'PAR_BEGIN' uses unsupported string operand s"));
        }
        finally
        {
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE", previousExecute);
    ...
    [Test]
    public void RunEmbeddedBytecode_CVmMode_ExecuteEnabledAwaitUnexpectedStringOperand_ReturnsCompatibilityError()
    {
        const string bytecodeText = "Bytecode#bc1(magic=\"AIBC\" format=\"AiBC1\" version=1 flags=0) { Func#f1(name=main params=\"\" locals=\"\") { Inst#i1(op=AWAIT s=\"meta\") } }";
        var previousExecute = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE");
        var previousLib = Environment.GetEnvironmentVariable("AIVM_C_BRIDGE_LIB");
        var lines = new List<string>();
        ...
        {
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE", "1");
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_LIB", "does-not-matter-for-await-s-operand");
            ...
            Assert.That(lines.Count, Is.EqualTo(1));
            Assert.That(lines[0], Does.Contain("code=DEV008"));
            Assert.That(lines[0], Does.Contain("Opcode 'AWAIT' uses unsupported string operand s"));
        }
        finally
        {
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE", previousExecute);
    ...
    [Test]
    public void AivmCBridge_TryLowerMainFunction_CallRemapsFunctionIndexToInstructionOffset()
    {
        const string bytecodeText = "Bytecode#bc1(magic=\"AIBC\" format=\"AiBC1\" version=1 flags=0) { Func#f1(name=helper params=\"\" locals=\"\") { Inst#i1(op=RET) } Func#f2(name=main params=\"\" locals=\"\") { Inst#i2(op=CALL a=0 b=0) Inst#i3(op=RET) } }";
        var parse = AosParsing.Parse(bytecodeText);
        Assert.That(parse.Root, Is.Not.Null);
        ...
        Assert.That(instructions[1], Is.EqualTo((12, 0)));
        Assert.That(instructions[2], Is.EqualTo((12, 0)));
        Assert.That(instructions[3], Is.EqualTo((11, 1)));
        Assert.That(instructions[4], Is.EqualTo((12, 0)));
        Assert.That(instructions[5], Is.EqualTo((12, 0)));
    }

    [Test]
    public void AivmCBridge_TryLowerMainFunction_AsyncCallRemapsFunctionIndexToInstructionOffset()
    {
        const string bytecodeText = "Bytecode#bc1(magic=\"AIBC\" format=\"AiBC1\" version=1 flags=0) { Func#f1(name=helper params=\"\" locals=\"\") { Inst#i1(op=RET) } Func#f2(name=main params=\"\" locals=\"\") { Inst#i2(op=ASYNC_CALL a=0 b=0) Inst#i3(op=RET) } }";
        var parse = AosParsing.Parse(bytecodeText);
        Assert.That(parse.Root, Is.Not.Null);
    ...
    [Test]
    public void AivmCBridge_TryLowerMainFunction_MainStartAccountsForExpandedEarlierFunction()
    {
        const string bytecodeText = "Bytecode#bc1(magic=\"AIBC\" format=\"AiBC1\" version=1 flags=0) { Func#f1(name=helper params=\"\" locals=\"\") { Inst#i1(op=CALL_SYS a=0 b=1 s=\"sys.console_writeLine\") Inst#i2(op=RET) } Func#f2(name=main params=\"\" locals=\"\") { Inst#i3(op=HALT) } }";
        var parse = AosParsing.Parse(bytecodeText);
        Assert.That(parse.Root, Is.Not.Null);
        ...
        Assert.That(instructions[0], Is.EqualTo((8, 5))); // Entry jump must account for helper CALL_SYS expansion.
        Assert.That(instructions[1], Is.EqualTo((15, 0))); // helper: injected CONST for CALL_SYS target.
        Assert.That(instructions[2], Is.EqualTo((22, 0))); // helper: CALL_SYS argc=0.
        Assert.That(instructions[3], Is.EqualTo((12, 0))); // helper: explicit RET.
        Assert.That(instructions[4], Is.EqualTo((12, 0))); // helper: sentinel RET.
        Assert.That(instructions[5], Is.EqualTo((1, 0)));  // main: HALT.
        Assert.That(instructions[6], Is.EqualTo((12, 0))); // main: sentinel RET.
    }
    ...
    [Test]
    public void RunSource_CVmMode_ProbeWithInvalidAbi_StillReturnsDev008Gate()
    {
        var lines = new List<string>();
        ...
        try
        {
            ...
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_ABI", " 1 ");
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_LIB", "does-not-matter-for-probe");
    ...
    public void RunSource_CVmMode_ExecuteEnabledBytecodeSource_UsesBridgeExecutePath()
    {
        ...
        try
        {
            File.WriteAllText(
                tempPath,
                "Bytecode#bc1(magic=\"AIBC\" format=\"AiBC1\" version=1 flags=0) { Func#f1(name=main params=\"\" locals=\"\") { Inst#i1(op=HALT) } }");
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE", "1");
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_LIB", "does-not-exist-aivm-bridge");
    ...
    public void RunSource_CVmMode_ExecuteEnabledProgramSource_StillReturnsBackendGate()
    {
        ...
        try
        {
            File.WriteAllText(
                tempPath,
                "Program#p1 { Let#l1(name=x) { Lit#v1(value=1) } }");
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_EXECUTE", "1");
            Environment.SetEnvironmentVariable("AIVM_C_BRIDGE_LIB", "does-not-matter-for-program-source");
