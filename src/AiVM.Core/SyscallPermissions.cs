...
public static class SyscallPermissions
{
    public static bool TryGetRequiredPermission(SyscallId id, out string permission)
    {
        permission = id switch
        {
            ...
            SyscallId.NetTcpConnectTls => "net",
            SyscallId.NetTcpConnectStart => "net",
            SyscallId.NetTcpConnectTlsStart => "net",
            SyscallId.NetTcpAccept => "net",
            SyscallId.NetTcpRead => "net",
            SyscallId.NetTcpReadStart => "net",
            SyscallId.NetTcpWrite => "net",
            SyscallId.NetTcpWriteStart => "net",
            SyscallId.NetAsyncPoll => "net",
            SyscallId.NetAsyncAwait => "net",
            SyscallId.NetAsyncCancel => "net",
            SyscallId.NetAsyncResultInt => "net",
            SyscallId.NetAsyncResultString => "net",
            SyscallId.NetAsyncError => "net",
